...
- **Интегрировать шаблонны** - интегрировать модуль с уже рабочими шаблонами хендлеров и клавиатур помимо стандартных (например готовый базовый интернет магазин)
